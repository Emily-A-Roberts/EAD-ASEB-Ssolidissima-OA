...
AICc(M1, M2, M3, M4, M5, M6, M7, M8, M9) # Full model within 2.2 AIC of best model
...
M6 <- update(M1, .~. + Treat:Month + Treat:Site)
M7 <- update(M1, .~. + Month:Site + Treat:Site) #Best model
M8 <- update(M1, .~. + Treat:Month + Treat:Site + Month:Site)
M9 <- update(M1, .~. + Treat:Month + Treat:Site + Month:Site + Treat:Month:Site)

AICc(M1, M2, M3, M4, M5, M6, M7, M8, M9) # Full model within 4 AIC of best model
...
AICc(M1, M2, M3, M4, M5, M6, M7, M8, M9) # Full model within 3 AIC of best model
```

```{r}
#Growth
  mod_growth_su <- lme(len_per_day*30~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_summer)
 
  mod_growth_fall_spr <- lme(len_per_day*30~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
...
#CI
  mod_CI_su <- lme(CI~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_summer)

  mod_CI_fall_spr <- lme(CI~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_fall_spring)
#Length
    mod_Len_su <- lme(Len~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_summer)
 
  mod_Len_fall_spr <- lme(Len~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_fall_spring)
#Tissue weight
    mod_AFDW_su <- lme(AFDW*30~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_summer)
 
  mod_AFDW_fall_spr <- lme(AFDW~Treat*Month*Site,
                        #*Month,
                        #+Start_len_mm+Start_len_mm:Site, 
                        random = ~1|Enclosure, 
                        data = growth_fall_spring)
...
```{r}
ft1 <- as_flextable(mod_growth_su, fit = "fixed", just = "center")%>%
...
ft2 <- as_flextable(mod_growth_fall_spr, fit = "fixed", just = "center")%>%
...
ft3 <- as_flextable(mod_CI_su, fit = "fixed", just = "center")%>%
...
ft4 <- as_flextable(mod_CI_fall_spr, fit = "fixed", just = "center")%>%
...
ft5 <- as_flextable(mod_Len_su, fit = "fixed", just = "center")%>%
...
ft6 <- as_flextable(mod_Len_fall_spr, fit = "fixed", just = "center")%>%
...
ft7 <- as_flextable(mod_AFDW_su, fit = "fixed", just = "center")%>%
...
ft8 <- as_flextable(mod_AFDW_fall_spr, fit = "fixed", just = "center")%>%
