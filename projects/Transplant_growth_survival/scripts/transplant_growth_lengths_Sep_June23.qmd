...
gg2 <- ggplot(data = growth, aes(x=as.factor(Collection.month), y=(Corrected.AFDW.using.an.average.of.82...Used.for..20.samples.with...organic...7.which.was.identified.to.caused.by.incomplete..anoxic..muffle.furnace.issues.), color = Treatment))+
  geom_boxplot()+
  xlab("Month") + 
...
gg2 <- ggplot(data = growth, aes(x=as.factor(Collection.month), y=(Corrected.AFDW.using.an.average.of.82...Used.for..20.samples.with...organic...7.which.was.identified.to.caused.by.incomplete..anoxic..muffle.furnace.issues.)/(Elapsed_days/30), color = Site))+
  geom_boxplot()+
  xlab("Month") + 
