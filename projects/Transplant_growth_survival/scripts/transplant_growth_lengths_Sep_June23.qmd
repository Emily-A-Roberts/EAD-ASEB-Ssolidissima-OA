...
reporting_period <- "fall_spring"
#reporting_period <- "summer" or "fall_spring" #Run for both to get graphs for both. 
```
...
wd <- "~/GitHub/EAD-ASEB-Ssolidissima-OA/projects/Transplant_growth_survival/data/"
growth_summer <- read.csv(file = paste(wd,"June2022_Sep2022_surfclam_transplant.xlsx - data.csv",sep=""), stringsAsFactors = F)
