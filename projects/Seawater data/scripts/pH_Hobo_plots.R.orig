...
# Next steps - need to upload more tide data and temp data from other sources and compare.
# Also need to include the last couple days of June tide data. 
...
# working directories
wdDen <- "~/Documents/School and jobs/Milford/Surfclam OA/Environmental conditions/HOBOpHdata/Dennis"
wdPtown <- "~/Documents/School and jobs/Milford/Surfclam OA/Environmental conditions/HOBOpHdata/Ptown"
wdEel <- "~/Documents/School and jobs/Milford/Surfclam OA/Environmental conditions/HOBOpHdata/Eel_pond"
...
# May to June # Bad data, before start of other loggers
# (open_file <- filenames[5]) 
# open_file <- "E Dennis 2022-06-13 08_04_00 EDT (Data EDT).csv"
...
# df <- df[df$datetime>"2022-05-25 00:00:00 EDT",]
# df <- df[df$datetime<"2022-06-07 00:00:00 EDT",]
