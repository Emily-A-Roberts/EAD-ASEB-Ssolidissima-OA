...
#Next -- check assumptions of ANOVA.... 
...
```{r}
gg1 <- ggplot(carb_dat[carb_dat$Stratum=="2cm"&carb_dat$Shell.treatment=="Shell",], aes(x=Date, y=pCO2_final, colour = Stratum))+
   geom_point(aes(), cex = 2, pch=22)+
    geom_line()+
   #ylim(7.2,8.3)+
   xlim(as.POSIXct(c("2022-09-01 00:00:00 EDT","2023-06-15 00:00:00 EDT")))+
theme_classic()+
      geom_point(
        data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",],
              aes(x=Date, y = pCO2_final, colour = Stratum),
             linetype=1, cex = 2, pch=19)+ #No shell is solid line
    geom_line(data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",])+
   geom_point(
 ...
 gg1 <- ggplot(carb_dat[carb_dat$Stratum=="2cm"&carb_dat$Shell.treatment=="Shell",], aes(x=Date, y=Arg.saturation, colour = Stratum))+
   geom_point(aes(), cex = 2, pch=22)+
    geom_line()+
   #ylim(7.2,8.3)+
   xlim(as.POSIXct(c("2022-09-01 00:00:00 EDT","2023-06-15 00:00:00 EDT")))+
theme_classic()+
      geom_point(
        data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",],
              aes(x=Date, y = Arg.saturation, colour = Stratum),
             linetype=1, cex = 2, pch=19)+ #No shell is solid line
    geom_line(data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",])+
   geom_point(
 ...
 gg_arg <- gg1
  ...
  gg1 <- ggplot(carb_dat[carb_dat$Stratum=="2cm"&carb_dat$Shell.treatment=="Shell",], aes(x=Date, y=Alkalinity, colour = Stratum))+
   geom_point(aes(), cex = 2, pch=22)+
    geom_line()+
   #ylim(7.2,8.3)+
   xlim(as.POSIXct(c("2022-09-01 00:00:00 EDT","2023-06-15 00:00:00 EDT")))+
theme_classic()+
      geom_point(
        data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",],
              aes(x=Date, y = Alkalinity, colour = Stratum),
             linetype=1, cex = 2, pch=19)+ #No shell is solid line
    geom_line(data = carb_dat[carb_dat$Stratum=="2cm"&
                          carb_dat$Shell.treatment=="No Shell",])+
   geom_point(
...
```{r}
 ggarrange(gg_pH, gg_arg, gg_pco2, gg_alk, common.legend = TRUE, legend="bottom")
```
...
```{r}
 ...
 str(carb_dat.LM)
 #carb_dat$Stratum <- as.factor(as.character(carb_dat$Stratum))
 summary(lm(data = carb_dat.LM, Arg.saturation ~ Stratum * Site * Shell.treatment))
 
  anova.m1 <- summary(lm(data = carb_dat.LM, InSitu.pH ~ Stratum * Site * Shell.treatment + Experiment))
