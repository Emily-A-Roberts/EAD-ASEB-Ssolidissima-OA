...
```{r}
Ptown <- Ptown[Ptown$Tideheight>2,] #This was at 0.4
Den <- Den[Den$Tideheight>3,] #This was at .5
Eel <- Eel[Eel$Tideheight>2,] #This was at 0. 
```
...
carb_dat <- carb_dat[carb_dat$Bad.data!="y",] #Exclude values Matt marked as likely questionable data
```
