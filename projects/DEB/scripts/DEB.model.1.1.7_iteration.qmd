...
if(Zone=='Prov'){
  ...
  Param$Xk=1.8 #Initial starting value for mle
    ...
    date_vec.P <- seq(date_start,date_end, by = 1)
}
...
if(Zone=='Eel'){
  ...
  date_vec.E <- seq(date_start,date_end, by = 1)
...
Growth.P$pred.growth <- Growth.pred.P
...
Growth.E$pred.growth <- Growth.pred.E
...
if(ncol(Growth.E)==ncol(Growth.P)){
