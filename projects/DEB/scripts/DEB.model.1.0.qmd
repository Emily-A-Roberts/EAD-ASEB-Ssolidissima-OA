...
Zone="MAB" # MAB; MABmes; GB ### here you can chose if you want to use forcing variables from the Mid atlantic Bight or Georges Bank
#ScRCP=8.5#"Validation"#;4.5#2.6; 4.5; 6; 8.5; Validation
#ScRCP=2.6
```

### Files for forcing variables
...
y <- MABpCO2 
lis <- loess(y ~ x, span= 0.25) #loess() fits a polynomial surface, used to interpolate I assume. 
...
colnames(Result)<-c("jour","E","V","Er","DFM","L","e","PM","Pc1","f","Pg","Pa","Temp",
                    "cT","Xnum","Pl1","Pl2","Pm1","Pj","Pr")#name the parameters
...
# 
#     
#     PM  <- (Pm * V)+(Param$del_pH*(min(max(pH[n]-Param$MpHl,0),Param$MpHh-Param$MpHl)*V^(2/3)))*cT_vec[j]#Maintenance costs 
# 
#     Pm1 <- min(PM,Param$Kappa * Pc1) #maintenance costs paid
#     
#     Pg  <- Param$Kappa * Pc1 - Pm1 #Growth
...
Simu=c(LResultmean[365*1.5],LResultmean[365*2.5],LResultmean[365*3.5],LResultmean[365*4.5],LResultmean[365*5.5],
       LResultmean[365*6.5],LResultmean[365*7.5],LResultmean[365*8.5],LResultmean[365*9.5],LResultmean[365*10.5],
       LResultmean[365*11.5],LResultmean[365*12.5],LResultmean[365*13.5],LResultmean[365*14.5],LResultmean[365*15.5],
       LResultmean[365*16.5],LResultmean[365*17.5],LResultmean[365*18.5],LResultmean[365*19.5],LResultmean[365*20.5],
       LResultmean[365*21.5],LResultmean[365*22.5],LResultmean[365*23.5],LResultmean[365*24.5],LResultmean[365*25])

Growth=as.data.frame(read.csv2(paste(dir_data,sep="","AgeDataArea.csv"),dec='.',sep=',',header=T))

   plot(seq(1:length(Resultmean))/365,LResultmean,type='l',lwd=2,ylim=c(0,20),xlim=c(0,25),ylab=ylabel,cex.lab=2,xlab="Time (y)",cex.axis=2)#,xlim=c(0,length(Resultmean)/365+0.25))
   text(0,19.5,"(B)")
